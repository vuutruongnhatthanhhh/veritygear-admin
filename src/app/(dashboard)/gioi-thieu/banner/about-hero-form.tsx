...
import { upsertAboutHero } from "./actions";
...
export function AboutHeroForm({ hero }: { hero: Hero }) {
  const [error, action, pending] = useActionState(upsertAboutHero, null);
  ...
  return (
    <form action={action} className="space-y-6">
      ...
      <ImageField label="Ảnh nền banner" initialUrl={hero?.image_url ?? null} bucket="about-images" pickerTitle="Chọn ảnh banner giới thiệu" />
